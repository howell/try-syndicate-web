        ...
        function (socket) {
            ...
            socket.on('message', function (message) {
                ...
                if (lastResponse !== null) {
                    console.log(`Overwriting previous response: ${lastResponse}`);
                }
            ...
            // sleep(2);
            // const parsedResponse = lastResponse && JSON.parse(lastResponse);
            // console.log(`Last response: ${lastResponse}`);
            // console.log(`Parsed response: ${parsedResponse}`);
            // lastResponse = null;
            // check(parsedResponse, {
            //     'Response format': (r) => Array.isArray(r),
            //     'Response is "phx_reply"': (r) => r[4] === 'phx_reply',
            //     'Response status is "ok"': (r) => typeof r[5] === 'object' && r[5].status === 'ok',
            // });
